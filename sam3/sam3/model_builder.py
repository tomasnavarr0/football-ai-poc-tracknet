...
def _default_bpe_path() -> str:
    """Return path to default BPE vocabulary file."""
    if pkg_resources is not None:
        try:
            return pkg_resources.resource_filename("sam3", "assets/bpe_simple_vocab_16e6.txt.gz")
        except Exception:
            pass
    return os.path.join(os.path.dirname(__file__), "assets", "bpe_simple_vocab_16e6.txt.gz")
